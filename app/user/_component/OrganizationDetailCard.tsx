    ...
    <div className="grid grid-cols-2 md:grid-cols-4 w-full  gap-6 px-2">
      {organizations.map((organization) => (
        <Link
          ...
          href={`/user/organization/${encodeURIComponent(organization.organizationName)}`}
          className="w-full h-93.75 bg-black/10 rounded-xl p-2 shadow-lg flex flex-col items-center hover:shadow-2xl"
        >
          <div className="w-full h-50.5 relative rounded-xl overflow-hidden border border-gray-500">
            {/* <Image
              src={profileImageUrl}
          ...
          <div className="w-full mt-2 text-sm space-y-1 ">
            ...
            <div className="flex flex-row gap-1">
              ...
              <p>{getWorkingHoursDisplay(organization.workingHours)}</p>
            </div>
